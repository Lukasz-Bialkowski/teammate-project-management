module.exports = function (grunt) {
    ...
    var taskConfig = {
        ...
        index: {
            ...
            build: {
                ...
                src: [
                    '<%= vendor_files.js %>',
                    // '<%= build_dir %>/src/**/*.js', FIXME This is a hack :)
                    '<%= html2js.common.dest %>',
                    '<%= html2js.app.dest %>',
                    '<%= vendor_files.css %>',
                    '<%= build_dir %>/assets/<%= pkg.name %>-<%= pkg.version %>.css'
    ...
    grunt.registerTask('build', [
        ...
        'copy:build_appjs', 'copy:build_vendorjs', 'copy:build_vendorcss', 'index:build', 'copy:fonts',
        'karmaconfig', 'karma:continuous', 'tags'
    ]);
